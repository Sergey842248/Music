...
public final class FragmentPlaylistDetailBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialTextView empty1;
  ...
  private FragmentPlaylistDetailBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull LinearLayout empty, @NonNull MaterialTextView empty1,
  ...
  public static FragmentPlaylistDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.empty;
      MaterialTextView empty1 = ViewBindings.findChildViewById(rootView, id);
      if (empty1 == null) {
        break missingId;
      }
      ...
      return new FragmentPlaylistDetailBinding((CoordinatorLayout) rootView, appBarLayout,
          container, empty, empty1, emptyText, progressIndicator, recyclerView, toolbar);
    }
