...
public final class ItemSongBinding implements ViewBinding {
  ...
  private ItemSongBinding(@NonNull ConstraintLayout rootView, @NonNull MaterialTextView artist,
  ...
  public static ItemSongBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.artist;
      MaterialTextView artist = ViewBindings.findChildViewById(rootView, id);
      if (artist == null) {
        break missingId;
      }
      ...
      return new ItemSongBinding((ConstraintLayout) rootView, artist, image, imageContainer,
          imageText, menu, time, title);
    }
