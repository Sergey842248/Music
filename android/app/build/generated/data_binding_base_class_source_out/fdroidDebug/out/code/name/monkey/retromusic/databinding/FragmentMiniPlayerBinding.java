...
public final class FragmentMiniPlayerBinding implements ViewBinding {
  ...
  @NonNull
  public final MaterialTextView miniPlayerTime;
  ...
  private FragmentMiniPlayerBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull MaterialTextView miniPlayerTime, @NonNull MaterialTextView miniPlayerTitle,
    ...
    this.miniPlayerTime = miniPlayerTime;
  ...
  public static FragmentMiniPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.miniPlayerTime;
      MaterialTextView miniPlayerTime = ViewBindings.findChildViewById(rootView, id);
      if (miniPlayerTime == null) {
        break missingId;
      }
      ...
      return new FragmentMiniPlayerBinding((LinearLayout) rootView, actionNext, actionPrevious,
          image, imageTextContainer, miniPlayerPlayPauseButton, miniPlayerTime, miniPlayerTitle,
          progressBar);
    }
