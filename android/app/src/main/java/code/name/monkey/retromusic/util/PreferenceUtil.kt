...
object PreferenceUtil {
    ...
    var skipLyricsPopup: Boolean
        get() = sharedPreferences.getBoolean(SKIP_LYRICS_POPUP, false)
        set(value) = sharedPreferences.edit { putBoolean(SKIP_LYRICS_POPUP, value) }
