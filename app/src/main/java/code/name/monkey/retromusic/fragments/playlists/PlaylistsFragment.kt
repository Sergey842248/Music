        ...
        viewLifecycleOwner.lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                for (path in songPaths) {
                    ...
                    if (foundSong != null) {
                        ...
                        withContext(Dispatchers.Main) {
                            Toast.makeText(requireContext(), "Song not found: $path", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
                ...
                if (songsToAddToPlaylist.isNotEmpty()) {
                    ...
                    withContext(Dispatchers.Main) {
                        Toast.makeText(requireContext(), "No songs found in the playlist file or no songs could be resolved.", Toast.LENGTH_LONG).show()
                    }
                }
